...
import com.alibaba.alibabaserver.api.ProviderApi;
...
public class ConsumerController {
    ...
    public String echo(@PathVariable String str) {
        System.out.println(restTemplate.getForObject("http://alibaba-provider/echo/" + str, String.class));
        System.out.println(providerApi.refreshToken(str));
        return "成功了";
    }
